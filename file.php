<?php
    ...
    $use_auth = true;
    $auth_users = array(
        'kominfo' => '$2a$10$Wk6VU/HYRK1mOJU.yvQp3ekxxQA0pc8HzYlYyhkWdamNOxy4neeau', 
    );
    ...
    <head>
        ...
        <style>
            ...
            *,*::before,*::after { box-sizing: border-box;}
            ...
            .message.error { border-color:green;color:green  }
            .message.alert { border-color:orange;color:orange  }
            .preview-img { max-width:100%;max-height:80vh;background:url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAIAAACQkWg2AAAAKklEQVR42mL5//8/Azbw+PFjrN9L5Lh91ZXLfxiEhqyo2bA1FCEzHXH6EVA2nyMZGPk-FffhfGJrbQqygjAS);cursor:zoom-in }
            ...
            table.dataTable thead .sorting { cursor:pointer;background-repeat:no-repeat;background-position:center right;background-image:url('data:image/png;base64,iVBORw0KGgoAAAANSUQBqhHGzyLlUXZHT521txL5Wgff2nnTGFMk-FffhfGJrbQqy1Bak9dUSJxC5wwax1Cq1e7BAdxD5SL+Tq/QCM1oNiJidwox0355mXnG/DrEtIQ6azioNZQxI0ykPhTQIwhCR+BmBYtlK7kLKwFHczMsoj92qMtCZUQBqhHGzyLlUXZHT521txL5Wgff2nnTGFMk-FffhfGJrbQqynPQ6P+GtLKwFHczMsoj92qMtCZUGQ1FXvXEwMA2nyMC'); }
            table.dataTable thead .sorting_asc { cursor:pointer;background-repeat:no-repeat;background-position:center right;background-image:url('data:image/png;base64,iVBORw0KGgoAAAANSUQBqhHGzyLlUXZHT521txL5Wgff2nnTGFMk-FffhfGJrbQqyuEuFxBPAGI2ahhWCsS/gDibUoO0gPgxEP8H4ttArEyuQYxAPBdqEAxPBImTY5gjEL9DM+wTENuQahAvEO9DMwiGdwAxOymGJQLxTyD+jgWDxCLKwFHczMsoj92qMtCZUGQ1FXvXEwMA2nyMrkJggg=='); }
            table.dataTable thead .sorting_desc { cursor:pointer;background-repeat:no-repeat;background-position:center right;background-image:url('data:image/png;base64,iVBORw0KGgoAAAANSUQBqhHGzyLlUXZHT521txL5Wgff2nnTGFMk-FffhfGJrbQqyBSggaqGu5FA/BOIv2PBIPFEUgxjB+IdQPwfC94HxLykus4GiD+hGfQOiB3AUpcTSTVi3LaEw5PvRAmDGtExbtdb95edhgjASL+AuJQaMcsGxBOAmGvopk8AVz1sLZgg0bsAAAAASUVORK5CYII='); }
